  ...
  module Vault
    class InsertTest < Test::Unit::TestCase
      ...
      def test_define_invalid_refs_string()
        assert_raises(Error) do
          _test_define(memory: @memory, address: 0x0000, length: 0x0001, refs: {code: [nil]})
        end
      end
    end
    ...
    class XrefsTest < Test::Unit::TestCase
      ...
      def test_different_xref_types()
       _test_define(memory: @memory, address: 0x0000, length: 0x0004, user_defined: { test: 'A'})
       _test_define(memory: @memory, address: 0x0004, length: 0x0004, user_defined: { test: 'B'}, refs: {data: [0x0000], code: [0x0000, 0x0004]})
      ...
      def test_xref_to_middle()
        _test_define(memory: @memory, address: 0x0000, length: 0x0004, user_defined: { test: 'A'})
        _test_define(memory: @memory, address: 0x0004, length: 0x0004, user_defined: { test: 'B'}, refs: {code: [0x0002]})
      ...
      def test_multiple_same_refs()
        _test_define(memory: @memory, address: 0x0000, length: 0x0004, user_defined: { test: 'A'})
        _test_define(memory: @memory, address: 0x0004, length: 0x0004, user_defined: { test: 'B'}, refs: {code: [0x0000, 0x0000, 0x0002]})
      ...
      def test_multiple_refs()
        _test_define(memory: @memory, address: 0x0000, length: 0x0004, user_defined: { test: 'A'}, refs: {code: [0x0004, 0x0008, 0x0009]})
        _test_define(memory: @memory, address: 0x0004, length: 0x0004, user_defined: { test: 'B'}, refs: {})
        _test_define(memory: @memory, address: 0x0008, length: 0x0004, user_defined: { test: 'C'}, refs: {})
      ...
      def test_multiple_xrefs()
        _test_define(memory: @memory, address: 0x0000, length: 0x0004, user_defined: { test: 'A'}, refs: {code: [0x0004, 0x0008, 0x0009]})
        _test_define(memory: @memory, address: 0x0004, length: 0x0004, user_defined: { test: 'B'}, refs: {code: [0x0008]})
        _test_define(memory: @memory, address: 0x0008, length: 0x0004, user_defined: { test: 'C'}, refs: {})
      ...
      def test_self_ref()
        ...
        _test_define(memory: @memory, address: 0x0004, length: 0x0004, user_defined: { test: 'B'}, refs: { code: [0x0005]})
      ...
      def test_delete_ref()
        _test_define(memory: @memory, address: 0x0000, length: 0x0004, user_defined: { test: 'A'}, refs: {code: [0x0004, 0x0008, 0x0009]})
        _test_define(memory: @memory, address: 0x0004, length: 0x0004, user_defined: { test: 'B'}, refs: {code: [0x0000, 0x0002, 0x000a]})
        _test_define(memory: @memory, address: 0x0008, length: 0x0004, user_defined: { test: 'C'}, refs: {})
      ...
      def test_xref_after_undos_and_redos()
        _test_define(memory: @memory, address: 0x0000, length: 0x0004, user_defined: { test: 'A'}, refs: { code: [0x0004, 0x0008, 0x0009]})
        _test_define(memory: @memory, address: 0x0004, length: 0x0004, user_defined: { test: 'B'}, refs: { code: [0x0000, 0x0002, 0x000a]})
        _test_define(memory: @memory, address: 0x0008, length: 0x0004, user_defined: { test: 'C'}, refs: { code: [0x0007]})
        _test_undefine(memory: @memory, address: 0x0000, length: 0x0001)
    ...
    class SaveRestoreTest < Test::Unit::TestCase
      def test_save_load()
        ...
        memory = Memory.load(memory.dump())
