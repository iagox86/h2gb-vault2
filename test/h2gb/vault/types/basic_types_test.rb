    ...
    class BasicTypesTest < Test::Unit::TestCase
      def setup()
        ...
        @workspace.transaction() do
          @workspace.create_block(block_name: 'test', base_address: 0x0000, raw: BASIC_TYPES_MEMORY)
        end
      ...
      def test_uint8_t_start()
        @updater.do([
          { action: :define_basic_type, block_name: 'test', address: 0x0000, type: :uint8_t }
        ])

        entry = @workspace.get_single(block_name: 'test', address: 0x0000)
      ...
      def test_uint8_t_end()
        @updater.do([
          { action: :define_basic_type, block_name: 'test', address: 0x0018, type: :uint8_t }
        ])

        entry = @workspace.get_single(block_name: 'test', address: 0x0018)
      ...
      def test_uint8_t_out_of_bounds()
        assert_raises(Error) do
          @updater.do([
            { action: :define_basic_type, block_name: 'test', address: 0x0019, type: :uint8_t }
          ])
        end
      end
      ...
      def test_uint16_t()
        @updater.do([
          { action: :define_basic_type, block_name: 'test', address: 0x0000, type: :uint16_t, options: { endian: :big} },
          { action: :define_basic_type, block_name: 'test', address: 0x0004, type: :uint16_t, options: { endian: :little} },
          { action: :define_basic_type, block_name: 'test', address: 0x0017, type: :uint16_t, options: { endian: :big} },
        ])
        ...
        entry = @workspace.get_single(block_name: 'test', address: 0x0004)
        expected = TestHelper.test_entry(address: 0x0004, type: :uint16_t, value: 0x0203, length: 2, raw: "\x03\x02".bytes())
        assert_equal(expected, entry)

        entry = @workspace.get_single(block_name: 'test', address: 0x0017)
      ...
      def test_uint16_t_out_of_bounds()
        assert_raises(Error) do
          @updater.do([
            { action: :define_basic_type, block_name: 'test', address: 0x0018, type: :uint16_t }
          ])
        end
      end
      ...
      def test_uint32_t()
        @updater.do([
          { action: :define_basic_type, block_name: 'test', address: 0x0000, type: :uint32_t, options: { endian: :big} },
          { action: :define_basic_type, block_name: 'test', address: 0x0004, type: :uint32_t, options: { endian: :little} },
          { action: :define_basic_type, block_name: 'test', address: 0x0015, type: :uint32_t, options: { endian: :big} },
        ])
        ...
        entry = @workspace.get_single(block_name: 'test', address: 0x0015)
      ...
      def test_uint32_t_out_of_bounds()
        assert_raises(Error) do
          @updater.do([
            { action: :define_basic_type, block_name: 'test', address: 0x0016, type: :uint32_t }
          ])
        end
      end
      ...
      def test_offset32()
        @updater.do([
          { action: :define_basic_type, block_name: 'test', address: 0x0000, type: :offset32, options: { endian: :big} },
          { action: :define_basic_type, block_name: 'test', address: 0x0004, type: :offset32, options: { endian: :little} },
          { action: :define_basic_type, block_name: 'test', address: 0x0015, type: :offset32, options: { endian: :big} },
        ])
      ...
      def test_rgb()
        @updater.do([
          { action: :define_basic_type, block_name: 'test', address: 0x0000, type: :rgb, options: { endian: :big} },
          { action: :define_basic_type, block_name: 'test', address: 0x0004, type: :rgb, options: { endian: :little} },
          { action: :define_basic_type, block_name: 'test', address: 0x0015, type: :rgb, options: { endian: :big} },
        ])
      ...
      def test_ntstring()
        @updater.do([
          { action: :define_basic_type, block_name: 'test', address: 0x0000, type: :ntstring },
          { action: :define_basic_type, block_name: 'test', address: 0x0008, type: :ntstring },
        ])
        ...
        entry = @workspace.get_single(block_name: 'test', address: 0x0008)
      ...
      def test_ntstring_runs_out_of_bounds()
        assert_raises(Error) do
          @updater.do([
            { action: :define_basic_type, block_name: 'test', address: 0x0011, type: :ntstring },
          ])
        end
      end
    end
