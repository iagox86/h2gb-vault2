...
module H2gb
  module Vault
    class MemoryTransactionTest < Test::Unit::TestCase
      def test_empty()
        memory_transaction = Memory::MemoryTransaction.new(
          opposites: {},
        )
    ...
    class MemoryTransactionUndoTest < Test::Unit::TestCase
    ...
    class MemoryTransactionRedoTest < Test::Unit::TestCase
      def test_basic_redo()
        memory_transaction = Memory::MemoryTransaction.new(
          opposites: {:a => :A, :A => :a},
        )
